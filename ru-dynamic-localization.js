(()=>{
  ...
  const EXACT=new Map(Object.entries({
    ...
    'WHO high priority':'Высокий приоритет WHO','WHO critical priority':'Критический приоритет WHO','Emerging fungal priority':'Приоритетный новый грибковый патоген','GLASS priority':'Приоритет GLASS','WHO/GLASS priority':'Приоритет WHO / GLASS',
