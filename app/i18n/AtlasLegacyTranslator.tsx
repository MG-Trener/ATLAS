...
const phrases: Variant[] = [
  ...
  { ru:"Средняя резистентность", kk:"Орташа төзімділік", en:"Mean resistance" },
  ...
  { ru:"Выбранный регион · 2026", kk:"Таңдалған өңір · 2026", en:"Selected region · 2026" },
  ...
  { ru:"Топ по резистентности", kk:"Төзімділік бойынша топ", en:"Top by resistance" },
  ...
  { ru:"сводный профиль R", kk:"жиынтық R профилі", en:"aggregate R profile" },
  ...
  { ru:"Микроорганизмы с наибольшим AMR", kk:"AMR деңгейі ең жоғары микроорганизмдер", en:"Organisms with highest AMR" },
